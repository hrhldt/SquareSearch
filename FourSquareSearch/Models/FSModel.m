...
- (void)setValue:(id)value forKey:(NSString *)key
{
    ...
    if (property != nil) {
        ...
        //object
            ...
            if ([class isSubclassOfClass:[FSModel class]]) {
                id object = (FSModel *)[[class alloc] initWithValue:value];
...
- (id)JSONValueForKey:(NSString *)key
{
    ...
    if ([object isKindOfClass:[NSArray class]]) {
        ...
        for (id subObject in object) {
            if ([subObject isKindOfClass:[FSModel class]]) {
                FSModel *subObjectModel = subObject;
